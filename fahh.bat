	...
	public class MasterChaos {
		...
		public static void Start() {
			...
			while (true) {
				...
				// 1. THE INVERTED TUNNEL (Squeezes + Inverts)
				if (rand.Next(0, 10) == 1) {
					// Squeeze the screen inward
					BitBlt(hdc, 15, 15, w - 30, h - 30, hdc, 0, 0, 0x00CC0020);
					// Invert the colors of the tunnel
			...
			MessageBox.Show("System restored. You've been pranked!", "Critical Alert", MessageBoxButtons.OK, MessageBoxIcon.Information);
		}
	}
'@
